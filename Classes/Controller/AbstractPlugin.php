...
class AbstractPlugin
{
    ...
    {
        return str_replace('_', '-', $this->prefixId) . ($this->prefixId !== '' && $this->prefixId !== '0' ? '-' : '') . $class;
    }
    ...
    public function pi_getLL(string $key, string $alternativeLabel = ''): ?string
    {
        ...
        } elseif ($this->altLLkey !== '' && $this->altLLkey !== '0') {
        ...
        if ($word === null) {
            if (
                ...
                $word = $this->LLtestPrefixAlt !== '' && $this->LLtestPrefixAlt !== '0' ? $this->LLtestPrefixAlt . $alternativeLabel : $alternativeLabel;
            }
        }
        return $this->LLtestPrefix !== '' && $this->LLtestPrefix !== '0' ? $this->LLtestPrefix . $word : $word;
    }
