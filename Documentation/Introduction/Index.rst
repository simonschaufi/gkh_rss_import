...
.. figure:: ../Images/ScreenshotPluginGeneralSettings.png
   :class: with-shadow
   :alt: Screenshot general settings
   :width: 761px

   General plugin settings

.. figure:: ../Images/ScreenshotPluginAdditionalSettings.png
   :class: with-shadow
   :alt: Screenshot additional settings
   :width: 761px

   Additional plugin settings

.. figure:: ../Images/ScreenshotRenderedFeed.png
   :alt: Screenshot rendered feed
   :width: 932px
